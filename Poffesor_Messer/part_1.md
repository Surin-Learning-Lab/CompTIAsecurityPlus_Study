...
3. primarily implemented and executed by people  
...
### **Which of the answers listed below refers to detective security controls**  
1. log monitoring  
2. security audits  
3. CCTV  
...
### **Which of the following answers refers to corrective security controls**  
1. recovering data from backup copies  
2. applying software updates and patches  
3. developing and implementing IRP's (incident response plans) to respond and recover from security incidents  
4. activating and executing DRP's (disaster recovery plans) to restore operations  
